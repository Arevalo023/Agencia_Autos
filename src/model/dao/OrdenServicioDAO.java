	...
	private OrdenServicio mapearOrdenBasico(ResultSet rs) throws SQLException {
	 ...
	 public OrdenServicio insertarNuevaOrden(
	        ...
	        try {
	            ...
	            psInsert.setString(1, ""); // folio temporal vacío
	            ...
	            // 3. generar folio a partir del id. Ejemplo: A + 3 dígitos con ceros
	            //    id = 7  -> A007
	            //    id = 123 -> A123
	            ...
	            // 6. regresar la orden ya completa usando tu método existente buscarPorFolio
	            return buscarPorFolio(folioGenerado);

	        } catch (SQLException ex) {
	            ex.printStackTrace();
	            // intento rollback si algo falló
	            if (cn != null) {
	 ...
	 /**
	    ...
	    // ---------------------------------------------------------
	    // ejemplo de cómo debería lucir buscarPorFolio(...) mínimo
	        ...
	        try (Connection cn = ConexionDB.getConnection();
	            ...
	            try (ResultSet rs = ps.executeQuery()) {
	                if (rs.next()) {
	                    ...
	                    // cargar refacciones detalle también si quieres
